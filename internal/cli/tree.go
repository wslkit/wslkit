...
func CommandTree() []cmdNode {
	return []cmdNode{
		...
		{Name: "top", Desc: "What the utility VM is using, and which distribution is responsible", Flags: []string{"--json", "--interval", "--once", "--watch", "--timeout"}, Positional: []argKind{argDistro}},
		{
			Name: "limit",
